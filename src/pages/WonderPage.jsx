...
export default function WonderPage() {
  ...
  useEffect(() => {
    stopNarration();
    const t = setTimeout(() => narrateText(NARRATION, 'thinking'), 500);
  ...
  return (
    <PageShell phase="wonder">
      <div style={{
        ...
        {/* Wonder card — matches reference dark card with ? icon */}
        <div className="card" style={{ width: '100%', padding: '2rem 2rem', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>

          {/* Purple circle with ruler icon — matches reference ? circle */}
          <div style={{
          ...
          <h2 style={{
            ...
            fontSize: 'clamp(1.15rem,3vw,1.45rem)', color: '#fff',
            ...
            <span style={{ color: 'var(--gold)' }}>5 m wide</span>. How much fencing does he need?
          </h2>
          ...
          {/* Hint pill — matches reference purple pill */}
          <div style={{
        ...
        {/* CTA */}
        <button className="btn-gold" style={{ width: '100%', maxWidth: '300px' }} onClick={handleGo}>
          🔍 Let&apos;s Investigate!
        </button>
      </div>
    </PageShell>
